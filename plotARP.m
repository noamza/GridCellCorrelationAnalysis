...
if isfield(arg,'show');  show=arg.show; end
if isfield(arg,'slmd');  slmd=arg.slimd; end
if isfield(arg,'rd');    rd=arg.rd; end
if isfield(arg,'ax');    ax=arg.ax; end
if isfield(arg,'tx');    tx=arg.tx; end
if isfield(arg,'ty');    ty=arg.ty; end
if isfield(arg,'lw');    lw=arg.lw; end
if isfield(arg,'ms');    ms=arg.ms; end
